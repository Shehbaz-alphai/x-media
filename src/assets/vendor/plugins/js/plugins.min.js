! function(t, e) {
    ...
    var nt, w, ot, st, rt, E, at, k, d, lt, n = C,
        ct = q,
        S = ct,
        A = T.expando,
        I = 0,
    ...
    try {
        S.apply(e = a.call(n.childNodes), n.childNodes), e[n.childNodes.length].nodeType
    } catch (nt) {
        S = {
            apply: function(t, e) {
                ct.apply(t, a.call(e))
        ...
        if (!n && (jt(e), e = e || E, k)) {
            ...
            if (!(ft[t + " "] || d && d.test(t))) {
                if (c = t, u = e, 1 === h && (_t.test(t) || bt.test(t))) {
                    for ((u = St.test(t) && Mt(e.parentNode) || e) == e && m.scope || ((r = e.getAttribute("id")) ? r = T.escapeSelector(r) : e.setAttribute("id", r = A)), s = (l = Rt(t)).length; s--;) l[s] = (r ? "#" + r : ":scope") + " " + Nt(l[s]);
                    c = l.join(",")
                }
                try {
    ...
    function jt(t) {
        ...
        return t != E && 9 === t.nodeType && t.documentElement && (at = (E = t).documentElement, k = !T.isXMLDoc(E), lt = at.matches || at.webkitMatchesSelector || at.msMatchesSelector, n != E && (t = E.defaultView) && t.top !== t && t.addEventListener("unload", At), m.getById = Lt(function(t) {
            return at.appendChild(t).id = T.expando, !E.getElementsByName || !E.getElementsByName(T.expando).length
            ...
            var e;
            at.appendChild(t).innerHTML = "<a id='" + A + "' href='' disabled='disabled'></a><select id='" + A + "-\r\\' disabled='disabled'><option selected=''></option></select>", t.querySelectorAll("[selected]").length || d.push("\\[" + i + "*(?:value|" + gt + ")"), t.querySelectorAll("[id~=" + A + "-]").length || d.push("~="), t.querySelectorAll("a#" + A + "+*").length || d.push(".#.+[+~]"), t.querySelectorAll(":checked").length || d.push(":checked"), (e = E.createElement("input")).setAttribute("type", "hidden"), t.appendChild(e).setAttribute("name", "D"), at.appendChild(t).disabled = !0, 2 !== t.querySelectorAll(":disabled").length && d.push(":enabled", ":disabled"), (e = E.createElement("input")).setAttribute("name", ""), t.appendChild(e), t.querySelectorAll("[name='']").length || d.push("\\[" + i + "*name" + i + "*=" + i + "*(?:''|\"\")")
        }), m.cssHas || d.push(":has"), d = d.length && new RegExp(d.join("|")), mt = function(t, e) {
            return t === e ? (rt = !0, 0) : !t.compareDocumentPosition - !e.compareDocumentPosition || (1 & (i = (t.ownerDocument || t) == (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !m.sortDetached && e.compareDocumentPosition(t) === i ? t === E || t.ownerDocument == n && O.contains(n, t) ? -1 : e === E || e.ownerDocument == n && O.contains(n, e) ? 1 : st ? b.call(st, t) - b.call(st, e) : 0 : 4 & i ? -1 : 1);
            var i
        }), E
    }
    for (nt in O.matches = function(t, e) {
            ...
            var e, i = [],
                n = 0,
                o = 0;
            if (rt = !m.sortStable, st = !m.sortStable && a.call(t, 0), K.call(t, mt), rt) {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, i = !t[6] && t[2];
                    return Ct.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && wt.test(i) && (e = Rt(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e), t[2] = i.slice(0, e)), t.slice(0, 3))
                }
            },
            filter: {
                TAG: function(t) {
                ...
                ATTR: function(e, i, n) {
                    return function(t) {
                        t = O.attr(t, e);
                        return null == t ? "!=" === i : !i || (t += "", "=" === i ? t === n : "!=" === i ? t !== n : "^=" === i ? n && 0 === t.indexOf(n) : "*=" === i ? n && -1 < t.indexOf(n) : "$=" === i ? n && t.slice(-n.length) === n : "~=" === i ? -1 < (" " + t.replace(vt, " ") + " ").indexOf(n) : "|=" === i && (t === n || t.slice(0, n.length + 1) === n + "-"))
                    }
                },
                ...
                PSEUDO: function(t, s) {
                    ...
                    return r[A] ? r(s) : 1 < r.length ? (e = [t, t, "", s], w.setFilters.hasOwnProperty(t.toLowerCase()) ? L(function(t, e) {
            ...
            pseudos: {
                ...
                lang: L(function(i) {
                    return xt.test(i || "") || O.error("unsupported lang: " + i), i = i.replace(h, p).toLowerCase(),
                        function(t) {
                            var e;
                            do {
    ...
    function Rt(t, e) {
        ...
        for (r = t, a = [], l = w.preFilter; r;) {
            for (s in i && !(n = yt.exec(r)) || (n && (r = r.slice(n[0].length) || r), a.push(o = [])), i = !1, (n = bt.exec(r)) && (i = n.shift(), o.push({
                    value: i,
                    type: n[0].replace(tt, " ")
                }), r = r.slice(i.length)), w.filter) !(n = Ct[s].exec(r)) || l[s] && !(n = l[s](n)) || (i = n.shift(), o.push({
                value: i,
                type: s,
                matches: n
            }), r = r.slice(i.length));
            ...
            if (e = w.relative[t[a].type]) u = [Ft(qt(u), e)];
                ...
                if ((e = w.filter[t[a].type].apply(null, t[a].matches))[A]) {
                    ...
                    return function t(p, f, m, g, v, e) {
                        return g && !g[A] && (g = t(g)), v && !v[A] && (v = t(v, e)), L(function(t, e, i, n) {
                            var o, s, r, a, l = [],
                                c = [],
                                u = e.length,
                                h = t || function(t, e, i) {
                            ...
                            if (m ? m(d, a = v || (t ? p : u || g) ? [] : e, i, n) : a = d, g)
                                for (o = Ht(a, c), g(o, [], i, n), s = o.length; s--;)(r = o[s]) && (a[c[s]] = !(d[c[s]] = r));
                            if (t) {
                                if (v || p) {
                                    if (v) {
    ...
    function $t(t, e) {
        var i, g, v, y, b, n, o = [],
            ...
            r = pt[t + " "];
        if (!r) {
            for (i = (e = e || Rt(t)).length; i--;)((r = Wt(e[i]))[A] ? o : s).push(r);
            (r = pt(t, (y = 0 < (v = o).length, b = 0 < (g = s).length, n = function(t, e, i, n, o) {
                var s, r, a, l = 0,
                    c = "0",
                    u = t && [],
                    h = [],
                ...
                for (o && (ot = e == E || e || o); c !== m && null != (s = p[c]); c++) {
                    if (b && s) {
                        for (r = 0, e || s.ownerDocument == E || (jt(s), i = !k); a = g[r++];)
                            if (a(s, e || E, i)) {
                                S.call(n, s);
                                break
                            }
    ...
    function Bt(t, e, i, n) {
        ...
        if (i = i || [], 1 === u.length) {
            ...
            for (o = Ct.needsContext.test(t) ? 0 : s.length; o-- && (r = s[o], !w.relative[a = r.type]);)
        ...
        return (c || $t(t, u))(n, e, !k, i, !e || St.test(t) && Mt(e.parentNode) || e), i
    }
    Pt.prototype = w.filters = w.pseudos, w.setFilters = new Pt, m.sortStable = A.split("").sort(mt).join("") === A, jt(), m.sortDetached = Lt(function(t) {
        return 1 & t.compareDocumentPosition(E.createElement("fieldset"))
    }), T.find = O, T.expr[":"] = T.expr.pseudos, T.unique = T.uniqueSort, O.compile = $t, O.select = Bt, O.setDocument = jt, O.escape = T.escapeSelector, O.getText = T.text, O.isXML = T.isXMLDoc, O.selectors = T.expr, O.support = T.support, O.uniqueSort = T.uniqueSort;
    ...
    var Gt, Zt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,
        Kt = ((T.fn.init = function(t, e, i) {
            if (!t) return this;
            if (i = i || Gt, "string" != typeof t) return t.nodeType ? (this[0] = t, this.length = 1, this) : y(t) ? void 0 !== i.ready ? i.ready(t) : t(T) : T.makeArray(t, this);
            if (!(n = "<" === t[0] && ">" === t[t.length - 1] && 3 <= t.length ? [null, t, null] : Zt.exec(t)) || !n[1] && e) return (!e || e.jquery ? e || i : this.constructor(e)).find(t);
            if (n[1]) {
                if (e = e instanceof T ? e[0] : e, T.merge(this, T.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : C, !0)), Yt.test(n[1]) && T.isPlainObject(e))
                    for (var n in e) y(this[n]) ? this[n](e[n]) : this.attr(n, e[n]);
                return this
            }
            return (i = C.getElementById(n[2])) && (this[0] = i, this.length = 1), this
        }).prototype = T.fn, Gt = T(C), /^(?:parents|prev(?:Until|All))/),
        Jt = {
            children: !0,
            contents: !0,
            next: !0,
    ...
    T.fn.extend({
        ...
        T.fn[n] = function(t, e) {
            ...
            return (e = "Until" !== n.slice(-5) ? t : e) && "string" == typeof e && (i = T.filter(e, i)), 1 < this.length && (Jt[n] || T.uniqueSort(i), Kt.test(n) && i.reverse()), this.pushStack(i)
        }
    });
    var z = /[^\x20\t\r\n\f]+/g;
    ...
    T.Callbacks = function(n) {
        var t, i;
        n = "string" == typeof n ? (t = n, i = {}, T.each(t.match(z) || [], function(t, e) {
            i[e] = !0
        }), i) : T.extend({}, n);
                ...
                r = {
                    ...
                    then: function(e, i, n) {
                            ...
                            return function() {
                                function t() {
                                    ...
                                    if (!(o < l)) {
                                        ...
                                        e = t && ("object" == typeof t || "function" == typeof t) && t.then, y(e) ? a ? e.call(t, c(l, s, ee, a), c(l, s, ie, a)) : (l++, e.call(t, c(l, s, ee, a), c(l, s, ie, a), c(l, s, ee, s.notifyWith))) : (r !== ee && (i = void 0, n = [t]), (a || s.resolveWith)(i, n))
                                    }
                                }
                                var i = this,
                                    n = arguments,
                                    e = a ? t : function() {
                                        try {
                                            ...
                                            T.Deferred.exceptionHook && T.Deferred.exceptionHook(t, e.error), l <= o + 1 && (r !== ie && (i = void 0, n = [t]), s.rejectWith(i, n))
                                        }
                                    };
                        ...
                        return T.Deferred(function(t) {
                            s[0][3].add(c(0, t, y(n) ? n : ee, t.notifyWith)), s[1][3].add(c(0, t, y(e) ? e : ee)), s[2][3].add(c(0, t, y(i) ? i : ie))
                        }).promise()
                    },
                    promise: function(t) {
        ...
        when: function(t) {
            ...
            var i = arguments.length,
                ...
                s = a.call(arguments),
                r = T.Deferred();
            if (i <= 1 && (ne(t, r.done(e(n)).resolve, r.reject, !i), "pending" === r.state() || y(s[n] && s[n].then))) return r.then();
    ...
    function re() {
        C.removeEventListener("DOMContentLoaded", re), x.removeEventListener("load", re), T.ready()
    }
    ...
    }), T.ready.then = se.then, "complete" === C.readyState || "loading" !== C.readyState && !C.documentElement.doScroll ? x.setTimeout(T.ready) : (C.addEventListener("DOMContentLoaded", re), x.addEventListener("load", re));
    ...
    function fe(t, e, i) {
        ...
        if (void 0 === i && 1 === t.nodeType)
            if (n = "data-" + e.replace(pe, "-$&").toLowerCase(), "string" == typeof(i = t.getAttribute(n))) {
                try {
    ...
    T.extend({
        ...
        data: function(i, t) {
            ...
            if (void 0 !== i) return "object" == typeof i ? this.each(function() {
                ...
                var e;
                if (s && void 0 === t) return void 0 !== (e = l.get(s, i)) || void 0 !== (e = fe(s, i)) ? e : void 0;
                this.each(function() {
                    l.set(this, i, t)
                })
            }, null, t, 1 < arguments.length, null, !0);
            if (this.length && (o = l.get(s), 1 === s.nodeType && !v.get(s, "hasDataAttrs"))) {
                for (e = r.length; e--;) r[e] && 0 === (n = r[e].name).indexOf("data-") && (n = D(n.slice(5)), fe(s, n, o[n]));
    ...
    function _e(t, e, i, n) {
        var o, s, r = 20,
            ...
            u = t.nodeType && (T.cssNumber[e] || "px" !== c && +l) && ge.exec(T.css(t, e));
        if (u && u[3] !== c) {
    ...
    function xe(t, e) {
        for (var i, n, o, s, r, a, l = [], c = 0, u = t.length; c < u; c++)(n = t[c]).style && (i = n.style.display, e ? ("none" === i && (l[c] = v.get(n, "display") || null, l[c] || (n.style.display = "")), "" === n.style.display && me(n) && (l[c] = (a = s = o = void 0, s = n.ownerDocument, r = n.nodeName, (a = we[r]) || (o = s.body.appendChild(s.createElement(r)), a = T.css(o, "display"), o.parentNode.removeChild(o), we[r] = a = "none" === a ? "block" : a)))) : "none" !== i && (l[c] = "none", v.set(n, "display", i)));
    ...
    var Ce = /^(?:checkbox|radio)$/i,
        ...
        g = ((s = C.createElement("input")).setAttribute("type", "radio"), s.setAttribute("checked", "checked"), s.setAttribute("name", "t"), o.appendChild(s), m.checkClone = o.cloneNode(!0).cloneNode(!0).lastChild.checked, o.innerHTML = "<textarea>x</textarea>", m.noCloneChecked = !!o.cloneNode(!0).lastChild.defaultValue, o.innerHTML = "<option></option>", m.option = !!o.lastChild, {
            thead: [1, "<table>", "</table>"],
    ...
    function Ae(t, e, i, n, o) {
        for (var s, r, a, l, c, u = e.createDocumentFragment(), h = [], d = 0, p = t.length; d < p; d++)
            ...
            for (r = r || u.appendChild(e.createElement("div")), a = (Te.exec(s) || ["", ""])[1].toLowerCase(), a = g[a] || g._default, r.innerHTML = a[1] + T.htmlPrefilter(s) + a[2], c = a[0]; c--;) r = r.lastChild;
            T.merge(h, r.childNodes), (r = u.firstChild).textContent = ""
        } else h.push(e.createTextNode(s));
        for (u.textContent = "", d = 0; s = h[d++];)
            if (n && -1 < T.inArray(s, n)) o && o.push(s);
            else if (l = ye(s), r = M(u.appendChild(s), "script"), l && ke(r), i)
    ...
    function ze(t, e, i, n, o, s) {
        var r, a;
        if ("object" == typeof e) {
            for (a in "string" != typeof i && (n = n || i, i = void 0), e) ze(t, a, i, n, e[a], s);
            return t
        }
        if (null == n && null == o ? (o = i, n = i = void 0) : null == o && ("string" == typeof i ? (o = n, n = void 0) : (o = n, n = i, i = void 0)), !1 === o) o = Le;
        else if (!o) return t;
    ...
    T.event = {
        ...
        add: function(e, t, i, n, o) {
            ...
            if (ue(e))
                for (i.handler && (i = (s = i).handler, o = s.selector), o && T.find.matchesSelector(ve, o), i.guid || (i.guid = T.guid++), (a = f.events) || (a = f.events = Object.create(null)), (r = f.handle) || (r = f.handle = function(t) {
                    ...
                    }), l = (t = (t || "").match(z) || [""]).length; l--;) h = p = (d = Ie.exec(t[l]) || [])[1], d = (d[2] || "").split(".").sort(), h && (c = T.event.special[h] || {}, h = (o ? c.delegateType : c.bindType) || h, c = T.event.special[h] || {}, p = T.extend({
                    type: h,
                    origType: p,
                    data: n,
                    handler: i,
        ...
        off: function(t, e, i) {
            ...
            if ("object" != typeof t) return !1 !== e && "function" != typeof e || (i = e, e = void 0), !1 === i && (i = Le), this.each(function() {
    ...
    function He(i, n, o, s) {
        ...
        if (h && (e = (t = Ae(n, i[0].ownerDocument, !1, i, s)).firstChild, 1 === t.childNodes.length && (t = e), e || s)) {
            for (a = (r = T.map(M(t, "script"), Ne)).length; u < h; u++) l = t, u !== d && (l = T.clone(l, !0, !0), a && T.merge(r, M(l, "script"))), o.call(i[u], l, u);
            if (a)
    ...
    function We(t, e, i) {
        for (var n, o = e ? T.filter(e, t) : t, s = 0; null != (n = o[s]); s++) i || 1 !== n.nodeType || T.cleanData(M(n)), n.parentNode && (i && ye(n) && ke(M(n, "script")), n.parentNode.removeChild(n));
        return t
    }
    T.extend({
        ...
        clone: function(t, e, i) {
            ...
            if (!(m.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || T.isXMLDoc(t)))
                for (r = M(u), n = 0, o = (s = M(t)).length; n < o; n++) a = s[n], "input" === (c = (l = r[n]).nodeName.toLowerCase()) && Ce.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (e)
                if (i)
                    for (s = s || M(t), r = r || M(u), n = 0, o = s.length; n < o; n++) qe(s[n], r[n]);
                else qe(t, u);
        ...
        empty: function() {
            for (var t, e = 0; null != (t = this[e]); e++) 1 === t.nodeType && (T.cleanData(M(t, !1)), t.textContent = "");
            return this
        },
        clone: function(t, e) {
        ...
        html: function(t) {
            return u(this, function(t) {
                ...
                if ("string" == typeof t && !Me.test(t) && !g[(Te.exec(t) || ["", ""])[1].toLowerCase()]) {
                    t = T.htmlPrefilter(t);
                    try {
                        for (; i < n; i++) 1 === (e = this[i] || {}).nodeType && (T.cleanData(M(e, !1)), e.innerHTML = t);
                        e = 0
                    } catch (t) {}
                }
        ...
        replaceWith: function() {
            ...
            return He(this, arguments, function(t) {
                ...
                T.inArray(this, i) < 0 && (T.cleanData(M(this)), e && e.replaceChild(t, this))
            }, i)
        }
    }), T.each({
        appendTo: "append",
    ...
    var Ve, Ue, Qe, Ye, Xe, Ge, Ze, r, Ke = new RegExp("^(" + t + ")(?!px)[a-z%]+$", "i"),
        Je = /^--/,
    ...
    function ni() {
        var t;
        r && (Ze.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0", r.style.cssText = "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%", ve.appendChild(Ze).appendChild(r), t = x.getComputedStyle(r), Ve = "1%" !== t.top, Ge = 12 === oi(t.marginLeft), r.style.right = "60%", Ye = 36 === oi(t.right), Ue = 36 === oi(t.width), r.style.position = "absolute", Qe = 12 === oi(r.offsetWidth / 3), ve.removeChild(Ze), r = null)
    }

    function oi(t) {
        return Math.round(parseFloat(t))
    }
    Ze = C.createElement("div"), (r = C.createElement("div")).style && (r.style.backgroundClip = "content-box", r.cloneNode(!0).style.backgroundClip = "", m.clearCloneStyle = "content-box" === r.style.backgroundClip, T.extend(m, {
    ...
    function pi(t, e, i, n, o, s) {
        ...
        for (; r < 4; r += 2) "margin" === i && (c += T.css(t, i + f[r], !0, o)), n ? ("content" === i && (l -= T.css(t, "padding" + f[r], !0, o)), "margin" !== i && (l -= T.css(t, "border" + f[r] + "Width", !0, o))) : (l += T.css(t, "padding" + f[r], !0, o), "padding" !== i ? l += T.css(t, "border" + f[r] + "Width", !0, o) : a += T.css(t, "border" + f[r] + "Width", !0, o));
    ...
    T.extend({
        ...
        style: function(t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                "string" == (s = typeof i) && (o = ge.exec(i)) && o[1] && (i = _e(t, e, o), s = "number"), null != i && i == i && ("number" !== s || l || (i += o && o[3] || (T.cssNumber[a] ? "" : "px")), m.clearCloneStyle || "" !== i || 0 !== e.indexOf("background") || (c[e] = "inherit"), r && "set" in r && void 0 === (i = r.set(t, i, n)) || (l ? c.setProperty(e, i) : c[e] = i))
            }
        },
        ...
        T.cssHooks[r] = {
            ...
            set: function(t, e, i) {
                var n = $e(t),
                    ...
                    i = i ? pi(t, r, i, s, n) : 0;
                return s && o && (i -= Math.ceil(t["offset" + r[0].toUpperCase() + r.slice(1)] - parseFloat(n[r]) - pi(t, r, "border", !1, n) - .5)), i && (s = ge.exec(e)) && "px" !== (s[3] || "px") && (t.style[r] = e, e = T.css(t, r)), di(0, e, i)
            }
        }
        ...
        T.cssHooks[o + s] = {
            expand: function(t) {
                for (var e = 0, i = {}, n = "string" == typeof t ? t.split(" ") : [t]; e < 4; e++) i[o + f[e] + s] = n[e] || n[e - 2] || n[0];
                return i
            }
        ...
        run: function(t) {
            ...
            return this.options.duration ? this.pos = e = T.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : this.pos = e = t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), (i && i.set ? i : c.propHooks._default).set(this), this
        }
    ...
    function wi(t, e) {
        ...
        for (e = e ? 1 : 0; n < 4; n += 2 - e) o["margin" + (i = f[n])] = o["padding" + i] = t;
    ...
    T.Animation = T.extend(j, {
        ...
        tweener: function(t, e) {
            for (var i, n = 0, o = (t = y(t) ? (e = t, ["*"]) : t.match(z)).length; n < o; n++) i = t[n], j.tweeners[i] = j.tweeners[i] || [], j.tweeners[i].unshift(e)
        },
    ...
    }, s = C.createElement("input"), o = C.createElement("select").appendChild(C.createElement("option")), s.type = "checkbox", m.checkOn = "" !== s.value, m.optSelected = o.selected, (s = C.createElement("input")).value = "t", s.type = "radio", m.radioValue = "t" === s.value;
        ...
        Pi = (T.extend(T.event, {
            trigger: function(t, e, i, n) {
                ...
                if (3 !== i.nodeType && 8 !== i.nodeType && !ji.test(d + T.event.triggered) && (-1 < d.indexOf(".") && (d = (p = d.split(".")).shift(), p.sort()), a = d.indexOf(":") < 0 && "on" + d, (t = t[T.expando] ? t : new T.Event(d, "object" == typeof t && t)).isTrigger = n ? 2 : 3, t.namespace = p.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), e = null == e ? [t] : T.makeArray(e, [t]), c = T.event.special[d] || {}, n || !c.trigger || !1 !== c.trigger.apply(i, e))) {
                    ...
                    for (o = 0;
                        (f = h[o++]) && !t.isPropagationStopped();) u = f, t.type = 1 < o ? r : c.bindType || d, (l = (v.get(f, "events") || Object.create(null))[t.type] && v.get(f, "handle")) && l.apply(f, e), (l = a && f[a]) && l.apply && ue(f) && (t.result = l.apply(f, e), !1 === t.result && t.preventDefault());
                    return t.type = d, n || t.isDefaultPrevented() || c._default && !1 !== c._default.apply(h.pop(), e) || !ue(i) || a && y(i[d]) && !R(i) && ((s = i[a]) && (i[a] = null), T.event.triggered = d, t.isPropagationStopped() && u.addEventListener(d, Oi), i[d](), t.isPropagationStopped() && u.removeEventListener(d, Oi), T.event.triggered = void 0, s && (i[a] = s)), t.result
                }
            },
    ...
    Xi.href = zi.href, T.extend({
        ...
        ajax: function(t, e) {
            ...
            if (v.promise(_), f.url = ((t || f.url || zi.href) + "").replace(Vi, zi.protocol + "//"), f.type = e.method || e.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(z) || [""], null == f.crossDomain) {
                o = C.createElement("a");
                try {
    ...
    var en = [],
        ...
        on = (T.ajaxSetup({
            ...
            return "string" != typeof t ? [] : ("boolean" == typeof e && (i = e, e = !1), e || (m.createHTMLDocument ? ((n = (e = C.implementation.createHTMLDocument("")).createElement("base")).href = C.location.href, e.head.appendChild(n)) : e = C), n = !i && [], (i = Yt.exec(t)) ? [e.createElement(i[1])] : (i = Ae([t], e, n), n && n.length && T(n).remove(), T.merge([], i.childNodes)));
            var n
...
function(t, e) {
    ...
    class St extends e {
        constructor(t, e) {
            super(t, e), this._interval = null, this._activeElement = null, this._isSliding = !1, this.touchTimeout = null, this._swipeHelper = null, this._indicatorsElement = h.findOne(".carousel-indicators", this._element), this._addEventListeners(), this._config.ride === xt && this.cycle()
        }
        static get Default() {
            return Et
        }
        ...
        to(t) {
            ...
            t > i.length - 1 || t < 0 || (this._isSliding ? y.one(this._element, wt, () => this.to(t)) : (e = this._getItemIndex(this._getActive())) !== t && (e = e < t ? bt : d, this._slide(e, i[t])))
        }
        dispose() {
        ...
        _setActiveIndicatorElement(t) {
            if (this._indicatorsElement) {
                const e = h.findOne(".active", this._indicatorsElement),
                    i = (e.classList.remove(Ct), e.removeAttribute("aria-current"), h.findOne(`[data-bs-slide-to="${t}"]`, this._indicatorsElement));
    ...
    y.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", function(t) {
        ...
        for (const t of h.find('[data-bs-ride="carousel"]')) St.getOrCreateInstance(t)
    }), t(St);
    const At = "show",
        It = "collapse",
        Ot = "collapsing",
    ...
    class Mt extends e {
        ...
        show() {
            if (!this._isTransitioning && !this._isShown()) {
                ...
                if (!((t = this._config.parent ? this._getFirstLevelChildren(".collapse.show, .collapse.collapsing").filter(t => t !== this._element).map(t => Mt.getOrCreateInstance(t, {
                    ...
                    this._element.classList.remove(It), this._element.classList.add(Ot), this._element.style[i] = 0, this._addAriaAndCollapsedClass(this._triggerArray, !0), this._isTransitioning = !0;
                    var e = "scroll" + (i[0].toUpperCase() + i.slice(1));
                    this._queueCallback(() => {
                        this._isTransitioning = !1, this._element.classList.remove(Ot), this._element.classList.add(It, At), this._element.style[i] = "", y.trigger(this._element, "shown.bs.collapse")
        ...
        hide() {
            if (!this._isTransitioning && this._isShown() && !y.trigger(this._element, "hide.bs.collapse").defaultPrevented) {
                ...
                this._element.style[e] = this._element.getBoundingClientRect()[e] + "px", W(this._element), this._element.classList.add(Ot), this._element.classList.remove(It, At);
                for (const e of this._triggerArray) {
                    var t = h.getElementFromSelector(e);
                    t && !this._isShown(t) && this._addAriaAndCollapsedClass([e], !1)
                }
                this._isTransitioning = !0, this._element.style[e] = "", this._queueCallback(() => {
                    this._isTransitioning = !1, this._element.classList.remove(Ot), this._element.classList.add(It), y.trigger(this._element, "hidden.bs.collapse")
                }, this._element, !0)
            }
        }
    ...
    y.on(document, "click.bs.collapse.data-api", Lt, function(t) {
        ...
        for (const t of h.getMultipleElementsFromSelector(this)) Mt.getOrCreateInstance(t, {
            toggle: !1
        }).toggle()
    }), t(Mt);
    var S = "top",
    ...
    var le = {
        ...
        fn: function(t) {
            ...
            })) : t) ? t : ae(t, L)), e = Jt(a), o = "y" === u ? S : O, n = "y" === u ? A : I, i = s.rects.reference[c] + s.rects.reference[u] - l[u] - s.rects.popper[c], l = l[u] - s.rects.reference[u], a = (a = ne(a)) ? "y" === u ? a.clientHeight || 0 : a.clientWidth || 0 : 0, o = t[o], t = a - e[c] - t[n], o = se(o, n = a / 2 - e[c] / 2 + (i / 2 - l / 2), t), s.modifiersData[r] = ((a = {})[u] = o, a.centerOffset = o - n, a))
        },
        effect: function(t) {
            var e = t.state,
                t = t.options.element,
    ...
    function ue(t) {
        var e = t.popper,
            ...
            f = S,
            m = window;
        l && (v = "clientHeight", g = "clientWidth", (y = ne(e)) === _(e) && "static" !== E(y = M(e)).position && "absolute" === r && (v = "scrollHeight", g = "scrollWidth"), n !== S && (n !== O && n !== I || o !== b) || (f = A, h = (h - ((t && y === m && m.visualViewport ? m.visualViewport.height : y[v]) - i.height)) * (a ? 1 : -1)), n !== O && (n !== S && n !== A || o !== b) || (p = I, u = (u - ((t && y === m && m.visualViewport ? m.visualViewport.width : y[g]) - i.width)) * (a ? 1 : -1)));
    ...
    function Ce(t, e, i) {
        return e === Rt ? xe((o = i, r = _(n = t), a = M(n), r = r.visualViewport, l = a.clientWidth, a = a.clientHeight, u = c = 0, r && (l = r.width, a = r.height, ((s = Kt()) || !s && "fixed" === o) && (c = r.offsetLeft, u = r.offsetTop)), {
            width: l,
            height: a,
            x: c + be(n),
            y: u
        })) : w(e) ? ((o = T(s = e, !1, "fixed" === i)).top = o.top + s.clientTop, o.left = o.left + s.clientLeft, o.bottom = o.top + s.clientHeight, o.right = o.left + s.clientWidth, o.width = s.clientWidth, o.height = s.clientHeight, o.x = o.left, o.y = o.top, o) : xe((r = M(t), l = M(r), a = ye(r), c = null == (c = r.ownerDocument) ? void 0 : c.body, n = k(l.scrollWidth, l.clientWidth, c ? c.scrollWidth : 0, c ? c.clientWidth : 0), u = k(l.scrollHeight, l.clientHeight, c ? c.scrollHeight : 0, c ? c.clientHeight : 0), r = -a.scrollLeft + be(r), a = -a.scrollTop, "rtl" === E(c || l).direction && (r += k(l.clientWidth, c ? c.clientWidth : 0) - n), {
            width: n,
            height: u,
            x: r,
            y: a
    ...
    function Ee(t, e) {
        var i, n, o, s, r, a, e = e = void 0 === e ? {} : e,
            ...
            c = (i = w(p) ? p : p.contextElement || M(t.elements.popper), p = h, n = c, s = "clippingParents" === (h = u) ? (r = we(ee(s = i)), w(o = 0 <= ["absolute", "fixed"].indexOf(E(s).position) && x(s) ? ne(s) : s) ? r.filter(function(t) {
            ...
            }, Ce(i, h, n))).width = p.right - p.left, p.height = p.bottom - p.top, p.x = p.left, p.y = p.top, p),
        ...
        fn: function(t) {
            ...
            if (!h.modifiersData[t]._skip) {
                for (var i = e.mainAxis, n = void 0 === i || i, i = e.altAxis, o = void 0 === i || i, i = e.fallbackPlacements, d = e.padding, p = e.boundary, f = e.rootBoundary, s = e.altBoundary, r = e.flipVariations, m = void 0 === r || r, g = e.allowedAutoPlacements, r = h.options.placement, e = D(r), i = i || (e !== r && m ? function(t) {
                        ...
                        }) ? {} : t).placement, o = t.boundary, s = t.rootBoundary, r = t.padding, a = t.flipVariations, l = void 0 === (t = t.allowedAutoPlacements) ? qt : t, c = j(n), t = c ? a ? Ft : Ft.filter(function(t) {
                            return j(t) === c
                        }) : L, u = (n = 0 === (n = t.filter(function(t) {
    ...
    var Ie = {
        ...
        ze = {
            ...
            fn: function(t) {
                ...
                w && (d && (d = "y" === b ? "height" : "width", r = (a = w[b]) + f[i = "y" === b ? S : O], l = a - f[c = "y" === b ? A : I], e = y ? -C[d] / 2 : 0, o = (v === z ? x : C)[d], v = v === z ? -C[d] : -x[d], s = u.elements.arrow, s = y && s ? Jt(s) : {
                    width: 0,
                    height: 0
                        ...
                        if (!f) {
                            ...
                            if (je(e, t)) {
                                p.rects = {
                                    ...
                                    } : ye(l)), x(r) ? ((d = T(r, !0)).x += r.clientLeft, d.y += r.clientTop) : u && (d.x = be(u))), {
    ...
    class f extends e {
        constructor(t, e) {
            super(t, e), this._popper = null, this._parent = this._element.parentNode, this._menu = h.next(this._element, Ue)[0] || h.prev(this._element, Ue)[0] || h.findOne(Ue, this._parent), this._inNavbar = this._detectNavbar()
        }
        static get Default() {
            return Je
        }
        ...
        show() {
            if (!a(this._element) && !this._isShown()) {
                ...
                if (!y.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
                    ...
                    this._element.focus(), this._element.setAttribute("aria-expanded", !0), this._menu.classList.add(Ve), this._element.classList.add(Ve), y.trigger(this._element, "shown.bs.dropdown", t)
                }
            }
        }
        hide() {
        ...
        _completeHide(t) {
            if (!y.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented) {
                ...
                this._popper && this._popper.destroy(), this._menu.classList.remove(Ve), this._element.classList.remove(Ve), this._element.setAttribute("aria-expanded", "false"), u.removeDataAttribute(this._menu, "popper"), y.trigger(this._element, "hidden.bs.dropdown", t)
            }
        }
        _getConfig(t) {
    ...
    y.on(document, Be, p, f.dataApiKeydownHandler), y.on(document, Be, Ue, f.dataApiKeydownHandler), y.on(document, $e, f.clearMenus), y.on(document, "keyup.bs.dropdown.data-api", f.clearMenus), y.on(document, $e, p, function(t) {
    ...
    class oi extends ut {
        ...
        dispose() {
            this._isAppended && (y.off(this._element, ei), this._element.remove(), this._isAppended = !1)
        }
        _getElement() {
            if (!this._element) {
        ...
        _append() {
            var t;
            this._isAppended || (t = this._getElement(), this._config.rootElement.append(t), y.on(t, ei, () => {
    ...
    class ci extends ut {
        ...
        activate() {
            this._isActive || (this._config.autofocus && this._config.trapElement.focus(), y.off(document, si), y.on(document, "focusin.bs.focustrap", t => this._handleFocusin(t)), y.on(document, "keydown.tab.bs.focustrap", t => this._handleKeydown(t)), this._isActive = !0)
        }
        deactivate() {
    ...
    class fi {
        ...
        hide() {
            ...
            this._disableOverFlow(), this._setElementAttributes(this._element, di, t => t + e), this._setElementAttributes(ui, di, t => t + e), this._setElementAttributes(hi, pi, t => t - e)
        }
        reset() {
            this._resetElementAttributes(this._element, "overflow"), this._resetElementAttributes(this._element, di), this._resetElementAttributes(ui, di), this._resetElementAttributes(hi, pi)
        }
        isOverflowing() {
    ...
    class xi extends e {
        constructor(t, e) {
            super(t, e), this._dialog = h.findOne(".modal-dialog", this._element), this._backdrop = this._initializeBackDrop(), this._focustrap = this._initializeFocusTrap(), this._isShown = !1, this._isTransitioning = !1, this._scrollBar = new fi, this._addEventListeners()
        }
        static get Default() {
            return _i
        }
        ...
        dispose() {
            y.off(window, mi), y.off(this._dialog, mi), this._backdrop.dispose(), this._focustrap.deactivate(), super.dispose()
        }
        handleUpdate() {
            this._adjustDialog()
        }
    ...
    class m extends e {
        ...
        show(t) {
            this._isShown || y.trigger(this._element, "show.bs.offcanvas", {
                relatedTarget: t
            }).defaultPrevented || (this._isShown = !0, this._backdrop.show(), this._config.scroll || (new fi).hide(), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), this._element.classList.add(Ci), this._queueCallback(() => {
        ...
        hide() {
            !this._isShown || y.trigger(this._element, "hide.bs.offcanvas").defaultPrevented || (this._focustrap.deactivate(), this._element.blur(), this._isShown = !1, this._element.classList.add("hiding"), this._backdrop.hide(), this._queueCallback(() => {
                this._element.classList.remove("show", "hiding"), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._config.scroll || (new fi).reset(), y.trigger(this._element, ki)
            }, this._element, !0))
        }
        dispose() {
    ...
    y.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', function(t) {
        ...
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(), a(this) || (y.one(e, ki, () => {
            n(this) && this.focus()
        }), (t = h.findOne(Ti)) && t !== e && m.getInstance(t).hide(), m.getOrCreateInstance(e).toggle(this))
    ...
    class Bi extends e {
        ...
        show() {
            ...
            if (this._isWithContent() && this._isEnabled) {
                ...
                if (!t.defaultPrevented && e) {
                    ...
                    if (this._element.ownerDocument.documentElement.contains(this.tip) || (n.append(i), y.trigger(this._element, this.constructor.eventName("inserted"))), this._popper = this._createPopper(i), i.classList.add(Ni), "ontouchstart" in document.documentElement)
                        for (const t of [].concat(...document.body.children)) y.on(t, "mouseover", H);
                    this._queueCallback(() => {
        ...
        _createTipElement(t) {
            ...
            if (!e) return null;
            e.classList.remove(Ri, Ni), e.classList.add(`bs-${this.constructor.NAME}-auto`);
            t = (t => {
        ...
        _getTemplateFactory(t) {
            return this._templateFactory ? this._templateFactory.changeContent(t) : this._templateFactory = new ji({ ...this._config,
                content: t,
    ...
    class Ki extends e {
        ...
        _maybeEnableSmoothScroll() {
            this._config.smoothScroll && (y.off(this._config.target, Yi), y.on(this._config.target, Yi, "[href]", t => {
        ...
        _process(t) {
            this._activeTarget !== t && (this._clearActiveClass(this._config.target), (this._activeTarget = t).classList.add(Xi), this._activateParents(t), y.trigger(this._element, "activate.bs.scrollspy", {
                relatedTarget: t
            }))
        }
        _activateParents(t) {
            if (t.classList.contains("dropdown-item")) h.findOne(".dropdown-toggle", t.closest(".dropdown")).classList.add(Xi);
            else
                for (const e of h.parents(t, ".nav, .list-group"))
                    for (const t of h.prev(e, ".nav-link, .nav-item > .nav-link, .list-group-item")) t.classList.add(Xi)
        }
        _clearActiveClass(t) {
    ...
    y.on(window, "load.bs.scrollspy.data-api", () => {
        for (const t of h.find('[data-bs-spy="scroll"]')) Ki.getOrCreateInstance(t)
    }), t(Ki);
    const Ji = "ArrowRight",
        tn = "ArrowDown",
        en = "active",
    ...
    class rn extends e {
        ...
        _activate(t, e) {
            t && (t.classList.add(en), this._activate(h.getElementFromSelector(t)), this._queueCallback(() => {
        ...
        _deactivate(t, e) {
            t && (t.classList.remove(en), t.blur(), this._deactivate(h.getElementFromSelector(t)), this._queueCallback(() => {
        ...
        _toggleDropDown(t, n) {
            ...
            })(".dropdown-toggle", en), t(".dropdown-menu", nn), o.setAttribute("aria-expanded", n))
        }
    ...
    y.on(document, "click.bs.tab", on, function(t) {
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(), a(this) || rn.getOrCreateInstance(this).show()
    }), y.on(window, "load.bs.tab", () => {
        for (const t of h.find('.active[data-bs-toggle="tab"], .active[data-bs-toggle="pill"], .active[data-bs-toggle="list"]')) rn.getOrCreateInstance(t)
    }), t(rn);
    const an = "show",
        ln = "showing",
        cn = {
    ...
    class hn extends e {
        ...
        show() {
            y.trigger(this._element, "show.bs.toast").defaultPrevented || (this._clearTimeout(), this._config.animation && this._element.classList.add("fade"), this._element.classList.remove("hide"), W(this._element), this._element.classList.add(an, ln), this._queueCallback(() => {
                this._element.classList.remove(ln), y.trigger(this._element, "shown.bs.toast"), this._maybeScheduleHide()
            }, this._element, this._config.animation))
        }
        hide() {
            !this.isShown() || y.trigger(this._element, "hide.bs.toast").defaultPrevented || (this._element.classList.add(ln), this._queueCallback(() => {
                this._element.classList.add("hide"), this._element.classList.remove(ln, an), y.trigger(this._element, "hidden.bs.toast")
            }, this._element, this._config.animation))
        }
        dispose() {
    ...
    var e = function(n, d, s) {
        ...
        var F, q, H, m, g, W, v, $, B, V, y, b, _, w, x, U, Q, Y, X, o, G, Z, K, J, C, T, E, tt, r, et, it, nt, k, ot, st, rt, at, lt, a, S = d.documentElement,
            ...
            vt = (Z = /^img$/i, K = /^iframe$/i, J = "onscroll" in n && !/(gle|ing)bot/.test(navigator.userAgent), E = -1, tt = function(t) {
                ...
                unveil: k = function(t) {
                    var e, i, n, o;
                    t._lazyRace || (!(o = "auto" == (n = (i = Z.test(t.nodeName)) && (t[A](f.sizesAttr) || t[A]("sizes")))) && g || !i || !t[A]("src") && !t.srcset || t.complete || L(t, f.errorClass) || !L(t, f.lazyClass)) && (e = z(t, "lazyunveilread").detail, o && yt.updateElem(t, !0, t.offsetWidth), t._lazyRace = !0, T++, nt(t, e, o, n, i))
                },
                _aLSL: Et
            }),
